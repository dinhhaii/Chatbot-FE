  ...
  return (
    <section id="description">
      ...
      <p>
        ...
        viris eloquentiam sed. Mea appareat omittantur eloquentiam ad, nam ei
        quas oportere democritum. Prima causae admodum id est, ei timeam
        inimicus sed. Sit an meis aliquam, cetero inermis vel ut. An sit illum
        euismod facilisis, tamquam vulputate pertinacia eum at.
      </p>
      ...
      <ul className="list_ok">
        <li>
          ...
          <p>
            ...
            mediocritatem. Mea in justo posidonium necessitatibus.
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        aliquam, cetero inermis vel ut. An sit illum euismod facilisis, tamquam
