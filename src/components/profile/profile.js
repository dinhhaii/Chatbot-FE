                  ...
                  <div className="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md">
                    ...
                    <ul className="kt-nav">
                      ...
                      <li className="kt-nav__foot">
                        <Link
                          class="btn btn-label-danger btn-bold btn-sm"
                          to="/">
                          Upgrade plan
                        </Link>
                        <Link
                ...
                <div className="kt-widget kt-widget--user-profile-1">
                  <div className="kt-widget__head">
                    <div className="kt-widget__media">
                      <img src="https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/COT77ZHDXYI6TNAD644ITGMC2I.jpg&w=1440" alt="" />
                    </div>
                    ...
                    <div className="kt-widget__items">
                      ...
                      <Link
                        ...
                        <span className="kt-widget__section">
                          ...
                          <span to="/" className="kt-widget__desc">
                            Tax information
                          </span>
                        </span>
